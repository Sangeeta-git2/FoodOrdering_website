    ...
    <div class="wrapper">
      ...
      <?php
       if(isset($_GET['id']))
        ...
        $_SESSION['category_no_found'] ="<div class = 'error'> Category not found</div>";
        ...
        header("location:".SITEURL.'admin/category-manage.php.');
           ...
           ?>
            ...
            if($current_image!= ""){
                ?>
                <img src="<?php echo SITEURL;?>images/categories/<?php echo $current_image; ?>" width="110px">
                <?php
            }
            else{
        ...
        if(isset($_POST['submit'])){
          ...
          if($current_image!==""){
            ...
            if($res2 ==TRUE){
                ...
                $_SESSION['update'] = "<div class = 'error'> Category is failed to update.</div>";
                header("location:".SITEURL.'admin/category-manage.php.');
            }
